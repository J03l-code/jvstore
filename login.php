...
.login-visual-logo { height: 250px; width: auto; object-fit: contain; align-self: center; margin-bottom: 2rem; }
.login-visual h2 {
    color: #fff;
    font-size: 1.6rem;
    font-weight: 800;
...
<div class="login-page">
  <div class="login-box">
    ...
    <div class="login-visual">
      <img src="<?= BASE_URL ?>img/logojvn.png" alt="JVN store" class="login-visual-logo"
